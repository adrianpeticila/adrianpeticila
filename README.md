...
- **[AI for Babies](https://aiforbabies.pages.dev/)** : AI explained for people with actual jobs. Interactive developer suite featuring an interactive prompt evaluator, 77-term AI dictionary, visual RAG masterclass, AGENTS.md spec builder, speculative decoding lab, agent gym simulator, WebMCP tool scanner, and marketing intelligence layer: [aiforbabies.pages.dev](https://aiforbabies.pages.dev) · [GitHub](https://github.com/adrianpeticila/ai-babies). Official Products: [Early Cognitive & Soundscapes Pack 0-12M](https://aiforbabies.gumroad.com/l/cognitive-pack).
- **[Flamin.go](https://github.com/adrianpeticila/flamin-go)** : creative growth engine & automated visual workflows.
...
- **Hydra** : the project shelf under [hydra.peticila.ro](https://hydra.peticila.ro). Small brand tools for marketing sanity, mostly in-browser and free:
...
- **aponia.ro**: scheduling and clinical respite suite for Romanian psychotherapists. Zero commission, zero middleman. In-browser [Clinical Tools](https://aponia.ro/wellbeing/demo-unelte.html) (Popas, Jupiter, Mars, Mercury) and [Rhea](https://aponia.ro/rhea/) visibility audit.
